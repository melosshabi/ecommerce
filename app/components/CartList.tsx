...
export default function CartList({productsArray} : CartListProps) {
  ...
  return (
    <div className={`w-[95dvw] h-[90dvh] overflow-scroll m-auto mb-4 rounded-lg p-2 shadow-[0_0_5px_black] sm:w-[75dvw] sm:p-8 lg:h-[80dvh] lg:w-[50dvw] lg:m-0 xl:w-[70dvw] ${cartItems.length === 0 ? 'flex justify-center items-center' : ''}`}>
      ...
      {cartItems.length === 0 && !reqPending && <p className='font-medium text-[2em]'>Your cart is empty</p>}
      {
        ...
        return (
          <div className="flex flex-col my-2 border-b border-black py-2" key={index}>

    ...
    <div className="reviews w-full">
        {
            ...
            <form className="sm:w-[90%]" onSubmit={(e) => handleReviewSubmit(e)}>
                <div className='flex'>
                    <div className=" mx-8 w-24 h-24 rounded-full overflow-hidden inline-flex items-center">
                        <Image src={session?.data?.user.image || userIcon} alt={'User Profile Picture'} width={1000} height={1000} className='w-full'/>
                    </div>

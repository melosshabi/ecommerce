    ...
    }
    {
        ...
        return (
            <div className="flex flex-col items-center my-4 py-4 border-b border-black md:flex-row md:justify-around lg:justify-start" key={index}>
                <div >
                <Image className="" src={item.productImage as string} width={200} height={200} alt="Wishlist item image"/>
            </div>
            ...
            <div className='text-center lg:m-auto'>
                ...
                <div className="flex justify-center my-6">
                    ...
                    <button className="p-2 rounded-md mx-4 transition-all duration-200 hover:bg-transparentBlack" title="Remove from wishlist" onClick={() => removeFromWishlist(session.status === "authenticated" ? session.data.user.userDocId : undefined, item._id)}>

...
export default function Wishlist({productsArray, userId}:WishlistProps) {

    const [wishlistItems, setWishlistItems] = useState<Array<WishlistProduct>>([])
        ...
        return (
            ...
            <div className='wishlist-item-details-wrapper'>
                ...
                <div className="wishlist-item-options">
                    <button className="wishlist-btns add-to-cart-btn" title="Add to cart" onClick={() => addToCart(userId, item._id, 1, false)}>
                    ...
                    <button className='wishlist-btns remove-btn' title="Remove from wishlist" onClick={() => removeFromWishlist(userId, item._id)}>

...
export default function UserProductsList() {
  ...
  return (
    <div className={`${reqPending && 'flex items-center justify-center'} w-[95dvw] h-[80dvh] overflow-y-scroll m-auto rounded-lg p-2 shadow-[0_0_5px_black] lg:w-[70dvw] lg:m-0`}>
              ...
              <div className="flex flex-col items-center border-b border-black my-4" key={index}>
                ...
                <div className='my-4'>
                  ...
                  <div className="flex justify-around my-2">
                    {/* Delete button */}
                    <button className="p-2 rounded-md mx-4 transition-all duration-200 hover:bg-transparentBlack" onClick={() => unlistProduct(index, product._id)}>
